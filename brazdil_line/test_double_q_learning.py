...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Run Double Q-Learning algorithm in Gridworld environment."
    )
    ...
    try:
        ...
        model = algs.double_q_learning.DQLearning.load("models/double_q_learning")
        ...
        model = algs.double_q_learning.DQLearning(
            env,
